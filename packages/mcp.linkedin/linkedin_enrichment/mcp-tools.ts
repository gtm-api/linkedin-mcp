...
export const linkedinEnrichmentTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    annotations: { title: 'Enrich company lite profile', ...PAID },
  },
  {
    ...base,
    ...
    annotations: { title: 'Resolve company vanity', ...PAID },
  },
  {
    ...base,
  ...
  },
  {
    ...
    annotations: { title: 'Enrich person certifications', ...PAID },
  },
  {
    ...base,
    ...
    annotations: { title: 'Enrich person recommendations', ...PAID },
  },
  {
    ...base,
