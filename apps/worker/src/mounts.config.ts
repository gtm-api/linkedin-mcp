...
export const MOUNTS: MountConfig[] = [
  ...
  },
  {
    ...
    instructions:
      'GTM LinkedIn antidetect & cloud browser infrastructure: browsers (create / run / stop / delete / access keys), proxies (connectivity & location checks), logs, cloud-browser occupancy & sessions. Create/run/stop/delete are protected (preview → confirm).',
    selectors: [
